  ...
  return (
    <div className='flex min:h-screen w-screen item-center justify-center pt-8 md:pt-40 bg-blue-300 pb-10 px-4 '>
      <div className='flex  w-90 md:w-300 rounded-full bg-white '>
        ...
        <button className='m-3 rounded-4xl text-sm md:text-lg bg-teal-800 px-2 md:px-8 md:py-4 py-2 text-white hover:bg-teal-700 hover:cursor-pointer flex items-center gap-2'><Search size={20}/>Search</button>
      </div>
    </div>
